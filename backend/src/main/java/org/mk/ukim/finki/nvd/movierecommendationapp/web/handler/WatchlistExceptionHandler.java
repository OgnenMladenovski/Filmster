...
public class WatchlistExceptionHandler extends AbstractExceptionHandler{

    @ExceptionHandler(WatchlistNotFoundException.class)
    public ResponseEntity<ApiErrorResponseDto> handleWatchlistNotFoundException(
            WatchlistNotFoundException watchlistNotFoundException,
            HttpServletRequest request
    ) {
        return buildResponse(
                HttpStatus.NOT_FOUND,
                watchlistNotFoundException.getMessage(),
                request
        );
    }
}
